...
import { creatorSpotlight } from '../../data/mockData';
import { Avatar } from '../ui/Avatar';
import { VerifiedBadge } from '../ui/Badge';
import { IconSparkles } from '../ui/Icons';

export const CreatorSpotlight = ({ isGuest, onRequireAuth }) => {
    ...
    <div className="glass-panel rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800/80 shadow-md dark:shadow-xl shadow-slate-200/50 dark:shadow-black/30">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Creator Spotlight</h3>
            <p className="text-[10px] text-slate-500 dark:text-slate-400">Featured Pioneers</p>
          </div>
        </div>
      </div>
